...
from examples.stg.test.ranks_loader import RankLoader
from examples.stg.test.users_loader import UserLoader
...
@dag(
    ...
    start_date=pendulum.datetime(2022, 12, 3, tz="UTC"),  # Дата начала выполнения дага. Можно поставить сегодня.
